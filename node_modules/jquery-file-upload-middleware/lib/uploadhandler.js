...
module.exports = function(options) {
    ...
    UploadHandler.prototype.get = function() {
        //edit by david,for get can't response jpg itself
        var reqtarget = path.join(options.uploadDir(), this.req.path)
        console.log(reqtarget)
        if (fs.existsSync(reqtarget)) {
            console.log(reqtarget)
            var tarStats = fs.statSync(reqtarget)
            if (tarStats.isFile()) {
                this.res.sendfile(reqtarget)
                return
            }
        }
